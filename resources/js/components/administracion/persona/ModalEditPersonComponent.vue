<template>
    <div class="modal fade xd2" id="modalProcesoEditPersona"  tabindex="10000" role="dialog"
          data-keyboard="false" data-backdrop="static">
          <page-loader v-if="loading==true"/>
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title w-100 text-center">EDITAR PERSONA</h5>
                </div>
                <div class="modal-body">
                    <form  @submit.prevent="editarPersona">
                        <div class="row">
                         ...
                         <div class="row">
                            <div class="mb-3 col-12 col-md-3">
                                ...
                                <input type="date"  class="form-control"  v-model="persona.fecha_registro" disabled>
                            ...
                            <div class="mb-3 col-12 col-md-3">
                                ...
                                <input type="text"  class="form-control mayus" v-model="persona.num_doc" maxlength="15">
                        ...
                        <div class="row">
                            <div class="mb-3 col-12 col-md-3">
                                ...
                                <input type="text"  class="form-control mayus" v-model="persona.dpto" maxlength="5">
                            </div>
                             <div class="mb-3 col-12 col-md-3">
                        ...
                        <div class="row" style="padding:10px">
                            ...
                            <div class="col-sm-7">
                                ...
                                <button type="button"
                                    class="btn btn-danger btn-pill"  @click="closeModalEditarPersona()"
...
<script>
    ...
    export default {
        ...
        methods:{
            getDataPersona(id){
                axios.get(`${this.variableGlobal}/datos-persona-edit/`+id).then(({data}) => {
                    this.persona = data[0];
                    this.persona.fecha_registro=moment(data[0].fecha_registro,'DD/MM/YYYY').format('YYYY-MM-DD');
                    this.persona.fecha_nac=moment(data[0].fecha_nac,'DD/MM/YYYY').format('YYYY-MM-DD');
            ...
            closeModalEditarPersona(){
                $('#modalProcesoEditPersona').modal('hide');
                Bus.$emit("DetalleEditPersona");
            },
            editarPersona(){
                this.loading=true;
                this.enviado=true;
                ...
                if (this.$v.$invalid) {
                    ...
                    formData.append('persona_id',this.selectEditPersona)
                    ...
                    var request ={
                        url:`${this.variableGlobal}/update-data-persona`,
                        method:'post',
                        data:formData
                    }
                    ...
                    this.loading=false;
                    this.closeModalEditarPersona();
                }
            }
        },
        created() {
            Bus.$on("modalEditarPersona", (data) => {
                this.loading=true;
                this.selectEditPersona=data;
                this.getTipoDepartamento();
                this.getTipoPersona();
                this.getTipoDocumento();
                this.getTipoSexo();
                this.getDataPersona(this.selectEditPersona);
            });
