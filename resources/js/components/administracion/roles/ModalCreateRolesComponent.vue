<template>
    <div class="modal fade xd2" id="modalCrearRoles"  tabindex="-1" role="dialog"
          data-keyboard="false" data-backdrop="static">
          <page-loader v-if="loading==true"/>
        <div class="modal-dialog " role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title w-100 text-center">CREAR ROLES</h5>
                </div>
                    ...
                    <form  @submit.prevent="guardarRoles">
                        ...
                        <div class="row">
                            ...
                            <div class="mb-3 col-12 col-md-4" style="margin-top:2%">
                                ...
                                <button type="button"
                                    class="btn btn-danger btn-pill"  @click="closeModalAgregarRoles()"
        ...
        methods:{
            guardarRoles(){
                ...
                if (this.$v.$invalid) {
                    ...
                    var request ={
                        url:`${this.variableGlobal}/store-data-roles`,
                        method:'post',
                        data:formData
                    }
                    ...
                    this.loading=false;
                    this.closeModalAgregarRoles();
                }
            },
            closeModalAgregarRoles(){
                this.limpiarRoles();
                $('#modalCrearRoles').modal('hide');
                Bus.$emit("DetalleCreateRoles");
            },
            limpiarRoles(){
                    this.rol.rol_nombre='',
