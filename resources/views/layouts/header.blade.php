<nav class="navbar navbar-fixed-top">
    <div class="container-fluid">
        ...
        <div class="navbar-brand">
            {{-- <a href="{{route('home')}}"><img src="{{asset('logos.png')}}" alt="Logo" class="img-responsive logo"></a> --}}
        </div>
        ...
        <div class="navbar-right">
            ...
            <div id="navbar-menu">
                <ul class="nav navbar-nav">
                    ...
                    <li>
                        <a href="{{ route('logout') }}" onclick="event.preventDefault(); document.getElementById('logout-form').submit();" class="icon-menu"><i class="icon-login"></i></a>
                    </li>
                </ul>
            </div>
        </div>
